        ...
        return(
            <div  className="container">
                ...
                <form onSubmit={this.handleSubmit}> 
                    ...
                    <input type="text" value={this.state.businessName} name="businessName" onChange={this.handleChange} id="businessName" /><br />
                    <label htmlFor="address">address</label><br />
                    <input type="text" value={this.state.address} name="address" onChange={this.handleChange} id="address" /><br />
